...
var y, c, I, k, g, n, v , k_hat, PI, PI_tilde, A, D, mc, w, R, lambda, mu, i, deta, dy, A_hat, D_hat, dI, dc, dR, Z, dn, u_c, u_n, deta_hat, U, L, dg;
...
varexo e_i exc exi exG;

//exc is the discount factor shock, exG is a government spending shock
...
omega = 0.22; //ratio of govt expenditure
