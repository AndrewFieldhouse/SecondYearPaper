...
// Decentralized Model of Fiscal Federalism Version 4:

// The entiriety of the sub-federal fiscal adjustement occurs thru government transfers
...
model;
    ...
    gs = (tau_ns+extau_ns)*w*n + (tau_c+extau_c)*c+TT+exTf;         //Sub-federal budget constraint, with endogenous federal transfer response
