...
// Decentralized Model of Fiscal Federalism Version 2:

// The entiriety of the sub-federal fiscal adjustement occurs thru consumption tax increases
...
var y, c, I, k, gf, gs, tau_c, Tf, TT, n, v , k_hat, PI, PI_tilde, A, D, mc, w, R, lambda, mu, i, deta, dy, A_hat, D_hat, dI, dc, dR, Z, dn, u_c, u_n, deta_hat, U, L, dgs, dgf, dTf, tau_n;
...
parameters Lss, tau_k, tau_ns, tau_nf, rho_r,sigma, sigma_I,beta,gamma,alpha, theta, epsilon, DELTA, rho_g, phi_pi, phi_y, omega_f, omega_s, omega_t, phi, delta,
   nss,Rss,mcss, wss, k_hatss,  epsilon_w,  kss,    css, yss, iss, lambdass, muss, Iss, uss, vss, PIss, PI_tildess, Ass, Dss, gsss, gfss, qss, rho_phi, rc, tau_nss;
